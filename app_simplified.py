...
if page == "Home":
    ...
    # Simplified chat interface without AI dependencies
    ...
    if prompt: 
        ...
        response = "Thank you for your question! This is a simplified version of Rail Madad. To enable full AI functionality, please configure the API keys in the secrets.toml file and install all required dependencies."
        ...
        if submit_button:
            if len(complaint) > 0:
                ...
                log = {
                    ...
                    'cno': cno,
                    'mail':str(mail),
                    'department': 'General',  # Simplified without AI routing
                    'issues': complaint[:100] + "..." if len(complaint) > 100 else complaint
                }
